...
class OrderItem(BaseModel):
    ...
    unit_price = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(Decimal('0.00'))], editable=False,blank=True)

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.__original_event_id = self.event_id
    ...
    def save(self, *args, **kwargs):
        ...
        event_changed = self.__original_event_id != self.event_id

        if is_new or event_changed:
